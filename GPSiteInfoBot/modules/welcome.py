...
import GPSiteInfoBot.modules.sql.welcome_sql as sql
import GPSiteInfoBot
from GPSiteInfoBot import (DEV_USERS,LOGGER,OWNER_ID,SUDO_USERS,SUPPORT_USERS,TIGER_USERS,sw,dispatcher,JOIN_LOGGER)
from GPSiteInfoBot.modules.helper_funcs.chat_status import (is_user_ban_protected,user_admin)
from GPSiteInfoBot.modules.helper_funcs.misc import build_keyboard, delete, revert_buttons
from GPSiteInfoBot.modules.helper_funcs.msg_types import get_welcome_type
from GPSiteInfoBot.modules.helper_funcs.string_handling import (escape_invalid_curly_brackets,markdown_parser)
from GPSiteInfoBot.modules.log_channel import loggable
from GPSiteInfoBot.modules.sql.clear_cmd_sql import get_clearcmd
from GPSiteInfoBot.modules.sql.global_bans_sql import is_user_gbanned
...
def new_member(update: Update, context: CallbackContext):
    ...
    for new_mem in new_members:
        ...
        if new_mem.id == bot.id and not GPSiteInfoBot.ALLOW_CHATS:

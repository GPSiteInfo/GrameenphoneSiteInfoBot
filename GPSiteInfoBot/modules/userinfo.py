...
from GPSiteInfoBot.__main__ import STATS, TOKEN, USER_INFO
import GPSiteInfoBot.modules.sql.userinfo_sql as sql
...
from GPSiteInfoBot.modules.sql.afk_sql import is_afk, check_afk_status
from GPSiteInfoBot.modules.sql.users_sql import get_user_num_chats
from GPSiteInfoBot.modules.helper_funcs.chat_status import sudo_plus
from GPSiteInfoBot.modules.helper_funcs.extraction import extract_user
from GPSiteInfoBot import telethn as GPSiteInfoBotTelethonClient
...
@GPSiteInfoBotTelethonClient.on(
    events.NewMessage(
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>📊 GPSiteInfoBots Current stats:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])

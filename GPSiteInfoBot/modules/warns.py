...
import telegram
from GPSiteInfoBot import TIGER_USERS, WHITELIST_USERS, dispatcher
...
from GPSiteInfoBot.modules.helper_funcs.chat_status import (
    ...
    user_admin,
    user_admin_no_reply)
from GPSiteInfoBot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from GPSiteInfoBot.modules.helper_funcs.string_handling import split_quotes
from GPSiteInfoBot.modules.log_channel import loggable
from GPSiteInfoBot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # GPSiteInfoBot's sticker
        keyboard = None
        log_reason = (
